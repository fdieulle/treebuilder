...
class TestFilterParser(unittest.TestCase):
    ...
    def test_equal(self):
        ...
        self.assertListEqual([True, False, False], result)
    ...
    def test_not_equal(self):
        ...
        syntax = 'Name != foo'
        result = parser.parse(self.lexer.tokenize(syntax))
        self.assertListEqual([False, True, True], result)
    ...
    def test_and_operator(self):
        ...
        result = parser.parse(self.lexer.tokenize(syntax))
        self.assertListEqual([False, False, False], result)
    ...
    def test_or_operator(self):
        ...
        result = parser.parse(self.lexer.tokenize(syntax))
        self.assertListEqual([True, True, True], result)
    ...
    def test_or_and_and_operator(self):
        ...
        result = parser.parse(self.lexer.tokenize(syntax))
        self.assertListEqual([False, True, False], result)
    ...
    def test_attributes(self):
        ...
        result = parser.parse(self.lexer.tokenize(syntax))
        self.assertListEqual([False, False, True], result)
